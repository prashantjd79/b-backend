...
//     address: { type: String },
//     // 🔹 Updated Status Field (to allow pausing and deleting users)
...
const userSchema = new mongoose.Schema(
  {
    ...
    status: {
      type: String,
      enum: ['Active', 'Paused', 'Deleted', 'Disapproved'],
      default: 'Disapproved',
    },
    ...
    timeAvailability: { type: String, default: 'Not Set' },

    // Creator-specific fields
    skills: [{ type: String }],
    batchAssignments: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Batch' }],
    ...
    roadmapEnrolled: { type: mongoose.Schema.Types.ObjectId, ref: 'Path' },
    assignmentsSubmitted: [
      {
        assignmentId: { type: mongoose.Schema.Types.ObjectId, ref: 'Assignment' },
        submissionDate: { type: Date },
